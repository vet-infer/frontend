  ...
  return (
    <label className="block">
      ...
      <select
        ...
        className={cn(
          "h-12 w-full rounded-lg border bg-white px-4 text-sm text-slate-700 outline-none transition focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 disabled:bg-slate-50 disabled:text-slate-400",
